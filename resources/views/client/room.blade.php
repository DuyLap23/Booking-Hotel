        ...
        <nav>
            <div class="nav nav-tabs rooms lh-room" id="nav-tab" role="tablist">
                <button class="nav-link active" id="nav-Deluxe-tab" data-bs-toggle="tab"
                    ...
                    aria-selected="true">
                    <img src="{{asset('themes/client/assets/img/room/1.jpg')}}" alt="1">
                    Deluxe Room
                </button>
                <button class="nav-link" id="nav-Single-tab" data-bs-toggle="tab" data-bs-target="#nav-Single"
                    ...
                    <img src="{{asset('themes/client/assets/img/room/2.jpg')}}" alt="2">
                    Single Room
                </button>
                <button class="nav-link" id="nav-Super-tab" data-bs-toggle="tab" data-bs-target="#nav-Super"
                    ...
                    <img src="{{asset('themes/client/assets/img/room/3.jpg')}}" alt="3">
                    Super Room
                </button>
                <button class="nav-link" id="nav-Presidential-tab" data-bs-toggle="tab"
                    ...
                    aria-selected="false">
                    <img src="{{asset('themes/client/assets/img/room/4.jpg')}}" alt="4">
                    Presidential Room
                </button>
            </div>
        </nav>
                ...
                <div class="container">
                    <div class="row p-0 lh-d-block">
                        ...
                        <div class="col-xl-6 col-lg-12 p-0">
                            <div class="room-img">
                                <img src="{{asset('themes/client/assets/img/room/room-1.jpg')}}" alt="room-img" class="room-image">
                                <a href="{{asset('themes/client/room-details.html')}}" class="link"><i class="ri-arrow-right-line"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="tab-pane fade" id="nav-Single" role="tabpanel" aria-labelledby="nav-Single-tab">
                <div class="container">
                    <div class="row p-0 lh-d-block">
                        ...
                        <div class="col-xl-6 col-lg-12 p-0">
                            <div class="room-img">
                                <img src="{{asset('themes/client/assets/img/room/room-2.jpg')}}" alt="room-img" class="room-image">
                                <a href="{{asset('themes/client/room-details.html')}}" class="link"><i class="ri-arrow-right-line"></i></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="tab-pane fade" id="nav-Super" role="tabpanel" aria-labelledby="nav-Super-tab">
                <div class="container">
                    <div class="row p-0 lh-d-block">
                        ...
                        <div class="col-xl-6 col-lg-12 p-0">
                            <div class="room-img">
                                <img src="{{asset('themes/client/assets/img/room/room-3.jpg')}}" alt="room-img" class="room-image">
                                <a href="{{asset('themes/client/room-details.html')}}" class="link"><i class="ri-arrow-right-line"></i></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="tab-pane fade" id="nav-Presidential" role="tabpanel" aria-labelledby="nav-Presidential-tab">
                <div class="container">
                    <div class="row p-0 lh-d-block">
                        ...
                        <div class="col-xl-6 col-lg-12 p-0">
                            <div class="room-img">
                                <img src="{{asset('themes/client/assets/img/room/room-4.jpg')}}" alt="room-img" class="room-image">
                                <a href="{{asset('themes/client/room-details.html')}}" class="link"><i class="ri-arrow-right-line"></i></a>
                            </div>
                        </div>
                    </div>
